...
public static class DependencyInjection
{
    ...
    private static ConfigurationManager AddYouAreShutUpAzureBus(this ConfigurationManager config)
    {
        var azureConnectionString = config.GetSection(AzureAppConfiguration.Key)
            .GetValue<string>(nameof(AzureAppConfiguration.ConnectionString));
    ...
    public static WebApplicationBuilder AddYouAreShutUpAzureBus(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.Configure<AzureServiceBusConfiguration>(
            builder.Configuration.GetSection(AzureServiceBusConfiguration.Key));
